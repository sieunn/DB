...
sys       : 시스템(system)단축어
as sysdba : 시스템 데이터베이스 어드민 (SYStem DataBase Admin)
설치할 때 작성한 비밀번호 작성하기
비밀번호는 눈에 보이지 않음
*/
...
RESOURCE : 테이블,인덱스,뷰 등을 생성할 수 있는 권한
        -> T반에서 특정행동이나 만들기 변경 설정할 수 잇는 권한
이 외 여러가지 권한 있음, 권한을 여러가지 한번에 작성할 때는 , 사용해서 작성
...
/*
테이블 생성하기
테이블이란? 데이터베이스에서 모든 데이터를 포함하는 공간
...
--KH CAFE 추가하기
INSERT INTO kh_cafe (C_ID, C_NAME, C_ADDRESS, C_PHONE, C_TIME) VALUES (1,'메가커피','서울시 강남구 강남동','02-888-8888','영업시간:09:00~18:00');
